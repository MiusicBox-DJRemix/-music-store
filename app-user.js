  ...
  grid.innerHTML = list.map(s => `
    <div class="song-card" data-id="${s.id}">
      ...
      <div class="song-info">
        ...
        <div class="song-footer" style="display: flex; justify-content: flex-end; align-items: center;">
          ...
          <div class="playlist-row">
            ${songs.map(s => `
              <div class="playlist-song-row" data-id="${s.id}">
                ...
                <div class="playlist-item-price" style="display: flex; align-items: center; gap: 4px;">
